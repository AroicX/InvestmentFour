                    ...
                    <div class="row no-padding">
                        <div class="col-md-12 col-sm-12 col-lg-12 text-left">
                            ...
                            <div class="x2-margin-top x30-font-size">
                                @if(App\Http\Controllers\AppController::getFacebookLink())<a href="{!! App\Http\Controllers\AppController::getFacebookLink() !!}" class="x15-margin-bottom white normal-link footer-nav x4-margin-right"><i class="fab fa-facebook"></i></a>@endif
